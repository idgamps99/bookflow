...
#   next if Book.exists?(title: book_data[0])

#   url = "https://www.googleapis.com/books/v1/volumes?q=#{(book_data[0])}&key=#{ENV['GOOGLE_API_KEY']}"
...
#     title: book_data[0],
#     author: data.dig("items", 0, "volumeInfo", "authors", 0) || "Unknown Author",
#     year_published: data.dig("items", 0, "volumeInfo", "publishedDate")&.to_i || 2023,
#     summary: data.dig("items", 0, "volumeInfo", "description") || "No summary available.",
#     page_count: data.dig("items", 0, "volumeInfo", "pageCount") || 200,
#     cover_url: data.dig("items", 0, "volumeInfo", "imageLinks", "smallThumbnail") || "",
#     key: data.dig("items", 0, "id") || "unknown_key",
#     overall_rating: book_data[1],
#     genre: book_data[2]
#   )
...
#       session_end: start_time + (30 + i * 15).minutes,
#       page_count: (10 + i * 5),
#       active: false
#     )
#   end
